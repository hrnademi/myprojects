...
import numpy as np
from utility import batch_gd_three_param, lr_closed_form, compute_MSE, feature_normalization
...
def main():
    ...
    # 1
    x1, x2 = feature_normalization(features=[x1, x2])   # feature normalization
    ...
    teta_batch, teta_cost_epoch_batch = batch_gd_three_param(
        x, y, iterations, learning_rate, init_teta0, init_teta1, init_teta2, model)  # b
